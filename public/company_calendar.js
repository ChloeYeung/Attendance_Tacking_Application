...
//!!!!!added event on the company_calendar handlebar!!!!!
//company_calendar
$(document).ready(function () {
    ...
    $("#addBtn").click(function (a) {
        ...
        $("#evoCalendarCom").evoCalendar("addCalendarEvent", events[curAdd]);
    ...
    $("#removeBtn").click(function (a) {
        ...
        $("#evoCalendarCom").evoCalendar("removeCalendarEvent", active_events[curRmv].id);
    ...
    function a(a) {
        ...
        $(a).addClass("active");
        $("#evoCalendarCom").evoCalendar("setTheme", b);
    }
